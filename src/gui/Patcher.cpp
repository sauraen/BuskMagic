...
Patcher::Patcher ()
{
    ...
    grpEdit->setBounds (528, 376, 242, 168);
    ...
    lblShowfile->setBounds (264, 0, 192, 24);
    ...
    btnLoad->setBounds (240, 208, 24, 24);
    ...
    lblAddQty->setBounds (272, 512, 40, 24);
    ...
    txtAddQty->setBounds (312, 512, 24, 24);
    ...
    lblAddFixID->setBounds (352, 512, 80, 24);
    ...
    txtAddFixID->setBounds (432, 512, 40, 24);
    ...
    txtAddUni->setBounds (360, 488, 40, 24);
    ...
    lblAddChn->setBounds (400, 488, 64, 24);
    ...
    txtAddChn->setBounds (464, 488, 32, 24);
    ...
    lblAddName->setBounds (272, 464, 80, 24);
    ...
    txtAddName->setText (String());

    txtAddName->setBounds (352, 464, 144, 24);
    ...
    lblName->setBounds (536, 440, 56, 24);
    ...
    txtAddName2->setText (String());

    txtAddName2->setBounds (592, 440, 136, 24);
    ...
    lblUni->setBounds (536, 464, 88, 24);
    ...
    txtUni->setBounds (624, 464, 40, 24);
    ...
    lblChn->setBounds (536, 488, 88, 24);
    ...
    txtChn->setBounds (624, 488, 32, 24);
    ...
    lblFixID->setBounds (536, 512, 72, 24);
    ...
    txtFixID->setBounds (608, 512, 40, 24);
    ...
    btnSetName->setBounds (728, 440, 32, 24);
    ...
    lblFixInfo->setBounds (536, 392, 224, 48);
    ...
    btnSetUni->setBounds (664, 464, 32, 24);
    ...
    btnSetChn->setBounds (656, 488, 72, 24);
...
<JUCER_COMPONENT documentType="Component" className="Patcher" componentName=""
  ...
  <GROUPCOMPONENT name="grpEdit" id="ac74fa1d06f306ee" memberName="grpEdit" virtualName=""
                  explicitFocusOrder="0" pos="528 376 242 168" title="Fixture Properties"/>
  ...
  <TEXTBUTTON name="btnLoad" id="8c8b9eb262b05176" memberName="btnLoad" virtualName=""
              explicitFocusOrder="0" pos="240 208 24 24" buttonText="&#8594;"
  ...
  <LABEL name="lblAddQty" id="fd17579f84d8bd06" memberName="lblAddQty"
         virtualName="" explicitFocusOrder="0" pos="272 512 40 24" edTextCol="ff000000"
  ...
  <TEXTEDITOR name="txtAddQty" id="e2d209a05f07ec0b" memberName="txtAddQty"
              virtualName="" explicitFocusOrder="0" pos="312 512 24 24" initialText="1"
              multiline="0" retKeyStartsLine="0" readonly="0" scrollbars="1"
              caret="1" popupmenu="1"/>
  <LABEL name="lblAddFixID" id="21a25c99119344c8" memberName="lblAddFixID"
         virtualName="" explicitFocusOrder="0" pos="352 512 80 24" edTextCol="ff000000"
  ...
  <TEXTEDITOR name="txtAddFixID" id="79fc8529f709c9b3" memberName="txtAddFixID"
              virtualName="" explicitFocusOrder="0" pos="432 512 40 24" initialText="0"
              multiline="0" retKeyStartsLine="0" readonly="0" scrollbars="1"
              caret="1" popupmenu="1"/>
  <LABEL name="lblAddUni" id="a6878538164fee45" memberName="lblAddUni"
         virtualName="" explicitFocusOrder="0" pos="272 488 88 24" edTextCol="ff000000"
  ...
  <TEXTBUTTON name="btnAdd" id="dba1c93ba1dd0819" memberName="btnAdd" virtualName=""
              explicitFocusOrder="0" pos="472 512 24 24" buttonText="&#8594;"
              connectedEdges="5" needsCallback="1" radioGroupId="0"/>
  <TEXTEDITOR name="txtAddUni" id="9cc577cb7f74ce1d" memberName="txtAddUni"
              virtualName="" explicitFocusOrder="0" pos="360 488 40 24" initialText="0000"
              multiline="0" retKeyStartsLine="0" readonly="0" scrollbars="1"
              caret="1" popupmenu="1"/>
  <LABEL name="lblAddChn" id="f4ac89258935f135" memberName="lblAddChn"
         virtualName="" explicitFocusOrder="0" pos="400 488 64 24" edTextCol="ff000000"
  ...
  <TEXTEDITOR name="txtAddChn" id="83dfdec8b81e43ff" memberName="txtAddChn"
              virtualName="" explicitFocusOrder="0" pos="464 488 32 24" initialText="512"
              multiline="0" retKeyStartsLine="0" readonly="0" scrollbars="1"
              caret="1" popupmenu="1"/>
  <LABEL name="lblAddName" id="99107f268414c8cd" memberName="lblAddName"
         virtualName="" explicitFocusOrder="0" pos="272 464 80 24" edTextCol="ff000000"
         edBkgCol="0" labelText="Fix. Names:" editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
         fontsize="15.0" kerning="0.0" bold="0" italic="0" justification="33"/>
  <TEXTEDITOR name="txtAddName" id="3a7ceb72d77a547f" memberName="txtAddName"
              virtualName="" explicitFocusOrder="0" pos="352 464 144 24" initialText=""
              multiline="0" retKeyStartsLine="0" readonly="0" scrollbars="1"
              caret="1" popupmenu="1"/>
  <LABEL name="lblName" id="e94edd1681fb7f17" memberName="lblName" virtualName=""
         explicitFocusOrder="0" pos="536 440 56 24" edTextCol="ff000000"
  ...
  <TEXTEDITOR name="txtAddName" id="53604091056169ab" memberName="txtAddName2"
              virtualName="" explicitFocusOrder="0" pos="592 440 136 24" initialText=""
              multiline="0" retKeyStartsLine="0" readonly="0" scrollbars="1"
              caret="1" popupmenu="1"/>
  <LABEL name="lblUni" id="644224b31f3c03eb" memberName="lblUni" virtualName=""
         explicitFocusOrder="0" pos="536 464 88 24" edTextCol="ff000000"
         edBkgCol="0" labelText="Universe: 0x" editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
         fontsize="15.0" kerning="0.0" bold="0" italic="0" justification="33"/>
  <TEXTEDITOR name="txtUni" id="c282a7df7cc3eafc" memberName="txtUni" virtualName=""
              explicitFocusOrder="0" pos="624 464 40 24" initialText="0000"
              multiline="0" retKeyStartsLine="0" readonly="0" scrollbars="1"
              caret="1" popupmenu="1"/>
  <LABEL name="lblChn" id="415308cf92be49f6" memberName="lblChn" virtualName=""
         explicitFocusOrder="0" pos="536 488 88 24" edTextCol="ff000000"
         edBkgCol="0" labelText="Starting chn:" editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
         fontsize="15.0" kerning="0.0" bold="0" italic="0" justification="33"/>
  <TEXTEDITOR name="txtChn" id="5b08460b7d853707" memberName="txtChn" virtualName=""
              explicitFocusOrder="0" pos="624 488 32 24" initialText="512"
              multiline="0" retKeyStartsLine="0" readonly="0" scrollbars="1"
              caret="1" popupmenu="1"/>
  <LABEL name="lblFixID" id="3f2dc52e7ee5fc2c" memberName="lblFixID" virtualName=""
         explicitFocusOrder="0" pos="536 512 72 24" edTextCol="ff000000"
  ...
  <TEXTEDITOR name="txtFixID" id="c04a79ebaf0219e" memberName="txtFixID" virtualName=""
              explicitFocusOrder="0" pos="608 512 40 24" initialText="0" multiline="0"
              retKeyStartsLine="0" readonly="0" scrollbars="1" caret="1" popupmenu="1"/>
  <TEXTBUTTON name="btnSetName" id="f07fef1e429ead06" memberName="btnSetName"
              virtualName="" explicitFocusOrder="0" pos="728 440 32 24" buttonText="Set"
  ...
  <TEXTBUTTON name="btnSetUni" id="94ba90b6fffbcdd5" memberName="btnSetUni"
              virtualName="" explicitFocusOrder="0" pos="664 464 32 24" buttonText="Set"
              connectedEdges="1" needsCallback="1" radioGroupId="0"/>
  <TEXTBUTTON name="btnSetChn" id="b36fbcb79ad2fbb5" memberName="btnSetChn"
              virtualName="" explicitFocusOrder="0" pos="656 488 72 24" buttonText="Set From"
              connectedEdges="1" needsCallback="1" radioGroupId="0"/>
